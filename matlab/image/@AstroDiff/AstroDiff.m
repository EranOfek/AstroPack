        ...
        function flagNonTransients(Obj, Args)
            ...
            for Iobj=1:1:Nobj
                Obj(Iobj).CatData = imProc.sub.flagNonTransients(Obj(Iobj),...
                    ...
                    'DChi2dofLimits', Args.DChi2dofLimits,...
                    'NRChi2dofLimits', Args.NRChi2dofLimits,...
                    ...
                    'PSFShapeXYMeanN', Args.PSFShapeXYMeanN, ...
                    'PSFShapeCovN', Args.PSFShapeCovN, ...
                    'PSFShapeProbThresholdN', Args.PSFShapeProbThresholdN, ...
                    'PSFShapeXYMeanD', Args.PSFShapeXYMeanD, ...
                    'PSFShapeCovD', Args.PSFShapeCovD, ...
                    'PSFShapeProbThresholdD', Args.PSFShapeProbThresholdD, ...
                    ...
                    'ScorrCorrectionParam', Args.ScorrCorrectionParam,...
