        ...
        function findTransients(Obj, Args)
            ...
            for Iobj=Nobj:-1:1
                ...
                Obj(Iobj).CatData = imProc.sub.findTransients(Obj(Iobj), ...
                    ...
                    'includeAperturePhot', Args.includeAperturePhot,...
                    ...
                    'include2ndMoments', Args.include2ndMoments,...
                    'includePVdist', Args.includePVdist,...
                    'includeGradientDir', Args.includeGradientDir...
                    );
            end
        end
