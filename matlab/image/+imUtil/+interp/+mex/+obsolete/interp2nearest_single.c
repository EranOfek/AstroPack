...
void nearestInterp2D(
    const double *X, const double *Y, const float *values,
    const double *outX, const double *outY,
    float *output, mwSize nRows, mwSize nCols, mwSize outRows, mwSize outCols)
{
                 ...
                 int nrhs, const mxArray *prhs[])
{
    ...
    plhs[0] = mxCreateNumericMatrix(outRows, outCols, mxSINGLE_CLASS, mxREAL);
