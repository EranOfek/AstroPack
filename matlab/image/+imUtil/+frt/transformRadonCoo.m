function [A,B,Theta,X0,L]=transformRadonCoo(RadonCoo1, RadonCoo2, RadonCoo3, SizeImage, SizeSubFrame, RadonStep)
    ...
    %          [A,B,Theta,X0,L]=imUtil.frt.transformRadonCoo(PeakI(1), 1,
    %          PeakI(2), size(Im), size(P{end}), numel(P));
