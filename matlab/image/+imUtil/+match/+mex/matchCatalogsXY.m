...
%              mex CXX=g++-9 -R2018a CXXFLAGS='$CXXFLAGS -O3 -std=c++17 -march=x86-64 -mtune=generic -fopenmp' LDFLAGS='$LDFLAGS -fopenmp -static-libstdc++ -static-libgcc' matchCatalogsXY.cpp
% Example:
%{
        RA1  = [10; 20; 30];
        Dec1 = [ 0;  1;  2];
