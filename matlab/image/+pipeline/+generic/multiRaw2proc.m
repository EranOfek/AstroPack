...
%toc
    ...
    IP.Counter = 0;
    IP.PathLevel = 'proc';
    [Future,IP] = saveProduct(IP, Coadd, 'Save',Args.SaveCoaddIm,...
                           'ParEval',false,...
                           'SaveFun',@write1,...
...
%     IP.Counter = 0;
%     IP.PathLevel = 'proc';
%     Future = saveProduct(IP, Coadd, 'Save',Args.SaveAsteroids,...
%                            'ParEval',false,...
%                            'SaveFun',@write1,...
%                            'SaveFunArgs',{'Cat',  'IsSimpleFITS',true, 'FileType','fits', 'WriteHeader',true, 'Append',false, 'OverWrite',true, 'WriteTime',false},...
%                            'PropFromHeader',false,...
%                            'CropID_FromInd',false,...
%                            'SetProp',{'Product','Asteroids', 'SubDir',Args.SubDir, 'BasePath',Args.BasePath, 'DataDir','', 'CropID',0, 'Level','proc','FieldID',FieldID,'ProjName',ProjName, 'FileType','mat'},...
%                            'DataDirFromProjName',true);
%     
%     
%     
