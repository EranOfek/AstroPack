function [AC,MS]=procGALEX(Args)
    ...
    arguments
        ...
        Args.MatchedColums    = {'RA','Dec','X1','Y1','SN_1','SN_2','SN_3','SN_4','MAG_CONV_2','MAGERR_CONV_2','MAG_CONV_3','MAGERR_CONV_3','FLAGS', 'MAG_PSF','MAGERR_PSF'};
    end
    ...
    for Iim=1:1:Nim
        ...
        AI = imProc.sources.findMeasureSources(AI, 'ColCell',Args.ColCell);
