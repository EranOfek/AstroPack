function PCcell = resolvePC(Input)
    ...
    % Example: PCcell = pipeline.last.quality.photCalib.resolvePC(R.PC);
    %          PCcell = pipeline.last.quality.photCalib.resolvePC(PC_array);
    %          PCcell = pipeline.last.quality.photCalib.resolvePC(R);
