function plotPhotResidualsVs(PC, Args)
    ...
    % Example: pipeline.last.quality.photCalib.plotPhotResidualsVs(R.PC);
    %          pipeline.last.quality.photCalib.plotPhotResidualsVs(R.PC, 'XField', 'Y-YPEAK');
    %          pipeline.last.quality.photCalib.plotPhotResidualsVs(R.PC, 'XField', 'FLAGS');
    %          pipeline.last.quality.photCalib.plotPhotResidualsVs(R.PC, 'XField', 'PSF_CHI2DOF');
