function bulkCalibrate(Args)
    ...
    %                             model, CalibArgs, etc.
    %                             Default reproduces the MagColPrefix='MAGAB__' /
    %                             pythonLike / RefSpecSlope=0 / LAST_NonlinFC
    %                             configuration.
    ...
    % Example:
    %   % Defaults: glob the source tree, skip-if-exists, pythonLike/NonlinFC:
    ...
    %                   'SelectionMethod','pythonLike', 'UseTAPClassprob', true, ...
    ...
    %       'FitArgs', {'MagColPrefix', 'MAGAB__', 'UseTypicalX', true, 'SelectionMethod','pythonLike', ...
    %                   'UseTAPClassprob', true, 'RefSpecSlope', 1.5, 'AddMagErr', false, ...
    %                   'CalibArgs', {'AirmassSource','compute', 'ApplyNutation', true, ...
    %                                 'SelectionMethod','pythonLike', 'OptSeqName','LAST_NormLin_Astropy', ...
    %                                 'SigmaClipMethod','median', 'UseTAPClassprob', true, ...
    ...
    arguments
        ...
        Args.FitArgs      cell       = {'MagColPrefix', 'MAGAB__', ...
                                        'UseTypicalX', true, 'SelectionMethod','pythonLike', ...
                                        'UseTAPClassprob', true, 'RefSpecSlope', 0, 'AddMagErr', false, ...
                                        'CalibArgs', {'AirmassSource','compute', 'ApplyNutation', true, ...
                                                      'SelectionMethod','pythonLike', 'OptSeqName','LAST_NonlinFC', ...
                                                      'SigmaClipMethod','median', 'UseTAPClassprob', true, ...
                                                      'XPixel', 1726, 'YPixel', 1726, 'Tran2DType','cheby1_4_xt', ...
