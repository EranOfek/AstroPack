function Report = compareMasksPipelines(OldPath, NewPath, Args)
    ...
    %          Report = pipeline.last.quality.masks.compareMasksPipelines(OldPath, NewPath);
    %          % Single file mode:
    ...
    MismatchDetails = struct('FileIdx', cell(MaxTotalDetails, 1), ...
                             ...
                             'OldRow', cell(MaxTotalDetails, 1), ...
                             'OldCol', cell(MaxTotalDetails, 1), ...
        ...
        if OldSizeY ~= ExpectedOldY || OldSizeX ~= ExpectedOldX
            ...
            if NumMismatches > 0
                ...
                for J = 1:MaxDetails
                    ...
                    MismatchDetails(DetailIdx).OldRow = R + Offset;
                    MismatchDetails(DetailIdx).OldCol = C + Offset;
