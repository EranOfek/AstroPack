        ...
        function [Result,OutTable]=findAllVisits(Obj, Args)
            ...
            for Ind=1:1:Nr
                ...
                OutTable(Ind,:) = [Result(Ind).Keys.MOUNTNUM, Result(Ind).Keys.CAMNUM, Result(Ind).JD,...
                                   Result(Ind).Keys.RA1, Result(Ind).Keys.DEC1, ...
                                   Result(Ind).Keys.RA2, Result(Ind).Keys.DEC2, ...
                                   Result(Ind).Keys.RA3, Result(Ind).Keys.DEC3, ...
                                   Result(Ind).Keys.RA4, Result(Ind).Keys.DEC4, ...
