function [Out, varargout] = medianSparse(Obj, OpArgs)
    % Return the median of AstroImage object images, using the tools.math.stat.medianSparse function
    ...
    %          - A cell array of arguments to pass to tools.math.stat.medianSparse
    %            Default is {10,false}
    ...
    [Out, varargout{1:nargout-1}] = funUnaryScalarWithMask(Obj, @tools.math.stat.medianSparse, 'OpArgs',OpArgs);
