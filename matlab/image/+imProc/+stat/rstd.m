function [Out, varargout] = rstd(Obj, varargin)
    ...
    %          rStd on non saturated pixels
    %          [a,b]=imProc.stat.rstd(AI,'BitNames',{'Saturated'},'UseNot',true)
    
    [Out, varargout{1:nargout-1}] = funUnaryScalarWithMask(Obj, @imUtil.background.rstd, 'OpArgs',{}, varargin{:});
