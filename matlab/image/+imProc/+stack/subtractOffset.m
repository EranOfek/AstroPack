function Result = subtractOffset(ImObj, Offset, Args)
    ...
    Result  = imProc.stack.applyUnaryFun(ImObj, Offset, @minus, 'OpArgs',{'all'}, 'DataProp',Args.DataProp, 'DataPropIn',Args.DataPropIn, 'CreateNewObj',Args.CreateNewObj, 'PreDivide',false);
