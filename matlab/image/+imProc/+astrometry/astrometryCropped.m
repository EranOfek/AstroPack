function [Result, CroppedAI, Summary] = astrometryCropped(Image, Args)
    ...
    arguments
        ...
        Args.RangeX(1,2)                  = [-1000 1000].*3.5;
        Args.RangeY(1,2)                  = [-1000 1000].*3.5;
        Args.StepX(1,1)                   = 2;
        Args.StepY(1,1)                   = 2;
    ...
    for Iim=1:1:Nim
        ...
        Summary(Iim).Scale    = 0.5.*(abs(Result(Iim).WCS.CD(1,2)) + abs(Result(Iim).WCS.CD(2,1))).*ARCSEC_DEG;   % arcsec
