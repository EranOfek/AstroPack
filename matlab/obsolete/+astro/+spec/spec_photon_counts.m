function [Flux,Counts]=spec_photon_counts(Spectrum,Filter,Extin,Radius,Dist)
...
[NewSpec,NewFilt]=astro.spec.eq_sampling([Spectrum.Wave,Spectrum.Int],Filter,[],InterpMethod);
