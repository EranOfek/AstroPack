...
CREATE INDEX table_f_idx_fdouble001 ON public.table_f
  USING btree (fdouble001);

CREATE INDEX table_f_idx_fdouble002 ON public.table_f
  USING btree (fdouble002);

CREATE INDEX table_f_idx_fdouble003 ON public.table_f
  USING btree (fdouble003);

CREATE INDEX table_f_idx_fdouble004 ON public.table_f
  USING btree (fdouble004);

CREATE INDEX table_f_idx_fdouble005 ON public.table_f
  USING btree (fdouble005);

CREATE INDEX table_f_idx_fdouble006 ON public.table_f
  USING btree (fdouble006);

CREATE INDEX table_f_idx_fdouble007 ON public.table_f
  USING btree (fdouble007);

CREATE INDEX table_f_idx_fdouble008 ON public.table_f
  USING btree (fdouble008);

CREATE INDEX table_f_idx_fdouble009 ON public.table_f
  USING btree (fdouble009);

CREATE INDEX table_f_idx_fdouble010 ON public.table_f
  USING btree (fdouble010);

CREATE INDEX table_f_idx_fdouble011 ON public.table_f
  USING btree (fdouble011);

CREATE INDEX table_f_idx_fdouble012 ON public.table_f
  USING btree (fdouble012);

CREATE INDEX table_f_idx_fdouble013 ON public.table_f
  USING btree (fdouble013);

CREATE INDEX table_f_idx_fdouble014 ON public.table_f
  USING btree (fdouble014);

CREATE INDEX table_f_idx_fdouble015 ON public.table_f
  USING btree (fdouble015);

CREATE INDEX table_f_idx_fdouble016 ON public.table_f
  USING btree (fdouble016);

CREATE INDEX table_f_idx_fdouble017 ON public.table_f
  USING btree (fdouble017);

CREATE INDEX table_f_idx_fdouble018 ON public.table_f
  USING btree (fdouble018);

CREATE INDEX table_f_idx_fdouble019 ON public.table_f
  USING btree (fdouble019);

CREATE INDEX table_f_idx_fdouble020 ON public.table_f
  USING btree (fdouble020);

CREATE INDEX table_f_idx_fdouble021 ON public.table_f
  USING btree (fdouble021);

CREATE INDEX table_f_idx_fdouble022 ON public.table_f
  USING btree (fdouble022);

CREATE INDEX table_f_idx_fdouble023 ON public.table_f
  USING btree (fdouble023);

CREATE INDEX table_f_idx_fdouble024 ON public.table_f
  USING btree (fdouble024);

CREATE INDEX table_f_idx_fdouble025 ON public.table_f
  USING btree (fdouble025);

CREATE INDEX table_f_idx_fdouble026 ON public.table_f
  USING btree (fdouble026);

CREATE INDEX table_f_idx_fdouble027 ON public.table_f
  USING btree (fdouble027);

CREATE INDEX table_f_idx_fdouble028 ON public.table_f
  USING btree (fdouble028);

CREATE INDEX table_f_idx_fdouble029 ON public.table_f
  USING btree (fdouble029);

CREATE INDEX table_f_idx_fdouble030 ON public.table_f
  USING btree (fdouble030);

CREATE INDEX table_f_idx_fdouble031 ON public.table_f
  USING btree (fdouble031);

CREATE INDEX table_f_idx_fdouble032 ON public.table_f
  USING btree (fdouble032);

CREATE INDEX table_f_idx_fdouble033 ON public.table_f
  USING btree (fdouble033);

CREATE INDEX table_f_idx_fdouble034 ON public.table_f
  USING btree (fdouble034);

CREATE INDEX table_f_idx_fdouble035 ON public.table_f
  USING btree (fdouble035);

CREATE INDEX table_f_idx_fdouble036 ON public.table_f
  USING btree (fdouble036);

CREATE INDEX table_f_idx_fdouble037 ON public.table_f
  USING btree (fdouble037);

CREATE INDEX table_f_idx_fdouble038 ON public.table_f
  USING btree (fdouble038);

CREATE INDEX table_f_idx_fdouble039 ON public.table_f
  USING btree (fdouble039);

CREATE INDEX table_f_idx_fdouble040 ON public.table_f
  USING btree (fdouble040);

CREATE INDEX table_f_idx_fdouble041 ON public.table_f
  USING btree (fdouble041);

CREATE INDEX table_f_idx_fdouble042 ON public.table_f
  USING btree (fdouble042);

CREATE INDEX table_f_idx_fdouble043 ON public.table_f
  USING btree (fdouble043);

CREATE INDEX table_f_idx_fdouble044 ON public.table_f
  USING btree (fdouble044);

CREATE INDEX table_f_idx_fdouble045 ON public.table_f
  USING btree (fdouble045);

CREATE INDEX table_f_idx_fdouble046 ON public.table_f
  USING btree (fdouble046);

CREATE INDEX table_f_idx_fdouble047 ON public.table_f
  USING btree (fdouble047);

CREATE INDEX table_f_idx_fdouble048 ON public.table_f
  USING btree (fdouble048);

CREATE INDEX table_f_idx_fdouble049 ON public.table_f
  USING btree (fdouble049);

CREATE INDEX table_f_idx_fdouble050 ON public.table_f
