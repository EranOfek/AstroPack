...
classdef DbQuery < Component
    ...
    methods
        function Obj = LastDb()
            ...
            Obj.Query = db.DbQuery('socsrv', 'localhost', 'Port', 5432, 'UserName', 'postgres', 'Password', 'postgres', 'DatabaseName', 'lastdb');
        end
    end
    ...
    methods
        ...
        function Result = createTable_raw_images()
            ...
            Q.addColumn(TN, 'exptime',  'single', 'default 0');            
            Q.addColumn(TN, 'camname',  'varchar', "default ''");
            ...
            Q.addColumn(TN, 'projname', 'varchar', "default ''");            
    ...
    methods
        function Result = addRawImage(Obj, FileName, H)
