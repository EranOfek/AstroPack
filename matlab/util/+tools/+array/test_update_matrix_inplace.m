function test_update_matrix_inplace()
    ...
    unittest_update_matrix_inplace1();

    for i = 1:100
        %unittest_update_matrix_inplace2();    
    end;

    test_update_matrix_inplace3();
    test_update_matrix_inplace4();    
end


function test_update_matrix_inplace3()
	...
	fprintf('test_update_matrix_inplace3: Average time: MATLAB: %f, MEX: %f: AVX2: %f\n', averageMatlabTime, averageMexTime, averageAvxTime);
end


function test_update_matrix_inplace4()
	...
	averageMexTime = averageMexTime / iterations;
    averageAvxTime = averageAvxTime / iterations;
	fprintf('test_update_matrix_inplace4: Average time: MATLAB: %f, MEX: %f: AVX2: %f\n', averageMatlabTime, averageMexTime, averageAvxTime);
end



function unittest_update_matrix_inplace1()
