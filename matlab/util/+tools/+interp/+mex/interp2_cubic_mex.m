% Fast mex for 2D cubic interpolation
...
% Compilation: mex -O CXXFLAGS="\$CXXFLAGS -O3 -fopenmp -mavx2 -mfma" LDFLAGS="\$LDFLAGS -fopenmp" interp2_cubic_mex.cpp
% Example: tools.interp.mex.interp2_cubic_mex(Xin,Yin,Z,Xout,Yout);