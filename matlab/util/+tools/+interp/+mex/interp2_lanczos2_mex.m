% Fast mex for 2D Lanczos2 interpolation
...
% Compilation: mex -O CXXFLAGS="\$CXXFLAGS -O3 -fopenmp -mavx2 -mfma" LDFLAGS="\$LDFLAGS -fopenmp" interp2_lanczos2_mex.cpp
% Example: tools.interp.mex.interp2_lanczos2_mex(Xin,Yin,Z,Xout,Yout);