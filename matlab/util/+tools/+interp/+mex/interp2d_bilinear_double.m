% 2D bi-linear interpolation - fast MEX for double inputs
...
% Compilation: mex interp2d_bilinear_double.cpp CXXFLAGS="\$CXXFLAGS -O3 -march=native -fopenmp" LDFLAGS="\$LDFLAGS -fopenmp"
