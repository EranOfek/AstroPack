function [T, Fig] = editInspectTable(T, Args)
    ...
    arguments
        ...
        Args.InspectFun        =     {@(x,y) disp(x),...
                                      @(x,y) pipeline.last.pipes.VisitVariability.plotLC(x),...
        ...
        Args.InspectFunArgs    = {{},{}, {},{},{}, {}, {}, {}, {}};
        Args.FunName           = {"Display Line", "Plot LC", "SIMBAD", "NED", "SDSS", "DECaLS", "PS1", "Daily Observability", "Yearly Observability"};
