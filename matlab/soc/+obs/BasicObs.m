...
classdef BasicObs < Component
    ...
    methods
        % Constructor    
        function Obj = BasicObs()
            Obj.needUuid();
            Obj.msgLog(LogLevel.Debug, 'BasicObs created: %s', Obj.Uuid);
        end
        
        
        % Destructor
        function delete(Obj)
            Obj.msgLog(LogLevel.Debug, 'BasicObs deleted: %s', Obj.Uuid);
        end        
    end
