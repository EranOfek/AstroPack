%
% THIS SPECIAL startup.m is used only on Chen's Windows Laptop
% C:\Users\chent\OneDrive\Documents\MATLAB\startup.m
%
% -------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
function doMyStartup()

fprintf('***************************************************************\n');
fprintf('THIS SPECIAL startup.m is used only on Chen Windows Laptop\n');
...
% Tells FileMap to scan all folders and update its list of folders
% The result is saved to FileMap.StorageFileName (default
% 'c:/temp/AstroPackFileMap_1.mat' or '/tmp/AstroPackFileMap_1.mat')

% Commented out 03/09/2024 probably because FileMap is branch planner is
% not up to date
