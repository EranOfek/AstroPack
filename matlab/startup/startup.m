...
function startup(Args)
    ...
    arguments
        ...
        Args.AstroPack_CatsHTMPath       = '/home/dana/catsHTM';
    ...
    if isempty(Args.AstroPack_CatsHTMPath)
        % set to default value
        Args.AstroPack_CatsHTMPath = '/mnt/euclid/catsHTM';
    end
...
function DirList=defaultDirs_AstroPack_CatsHTMPath(DirList, CatsHTMDir)
    ...
    DirList.CatsHTM = {{CatsHTMDir,'2MASS'},...
                           ...
                           {CatsHTMDir,'DECaLS','DR10'},...
                           {CatsHTMDir,'FIRST'},...
                           {CatsHTMDir,'ForcedPhotList'},...
                           {CatsHTMDir,'GAIA','DR1'},...
                           {CatsHTMDir,'GAIA','DR2'},...
			   ...
			   {CatsHTMDir,'GAIA','DR3var'},...
                           {CatsHTMDir,'GALEX','DR6Plus7'},...
                           {CatsHTMDir,'GALEX','DR6Plus7Old'},...
                           {CatsHTMDir,'GLADE','v0'},...
                           {CatsHTMDir,'GLADE','v1'},...
                           ...
                           {CatsHTMDir,'NED','20170328'},...
                           {CatsHTMDir,'NED','20180502'},...
                           {CatsHTMDir,'NED','20260512'},...
                           {CatsHTMDir,'NOAO','merged'},...
                           {CatsHTMDir,'NVSS'},...
                           {CatsHTMDir,'PGC'},...
                           {CatsHTMDir,'PGC','PGC_old'},...
                           {CatsHTMDir,'PS1','DR1'},...
                           {CatsHTMDir,'PS1','DR2'},...
                           {CatsHTMDir,'PTFpc'},...
