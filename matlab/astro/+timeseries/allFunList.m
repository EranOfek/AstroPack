...
%      timeseries.binFullOverlap - Bin light curve with finite ExpTime using only points fully covering
...
%           timeseries.fitPeriod - fit a light curve with an harmonic (sin/cos) series
% timeseries.fitPolyFiniteExpTime - 
...
%               timeseries.fmaxs - Find local maxima by diffrentiation
%             timeseries.folding - Folding a timeseries by some period
%         timeseries.foldingStat - 
...
%                 timeseries.hjd - JD to heliocentric JD
...
%  timeseries.removeFluxBeforeT0 - Given a LC, remove baseline flux, and any flux detected before t0.
...
%      timeseries.vonNeumannStat - Calculate the unbiased von Neumann statistics for a time series.
