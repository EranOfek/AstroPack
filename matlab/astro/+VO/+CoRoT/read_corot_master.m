...
Dir = io.files.which_dir('read_corot_master');
TableDir = 'LC';
...
[CCDs,CCDind,CCDflag] = tools.cell.group_cellstr(Master{TbCol.CCDhalf});
Nccd = length(CCDs);
Ind.CCD.junk = [];
for Iccd=1:1:Nccd
...
[RunCodes,RunCodesInd,RunCodesFlag]=tools.cell.group_cellstr(Master{TbCol.RunCode});
