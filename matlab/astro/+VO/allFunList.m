...
% VO.ZTF.reanalizeFieldCam_ZTF_psfcat - For all images in Field/camera - Given ZTF psfcat apply  photometric ZP, astrometry and match to known asteroids
%    VO.ZTF.reanalize_ZTF_psfcat - Given ZTF psfcat apply  photometric ZP, astrometry and match to known asteroids
%       VO.ZTF.wgetList_ztf_phot - Run wget_ztf_phot on a list of targets
