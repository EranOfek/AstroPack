...
switch lower(InPar.UseSpecExtract)
    case 'y'
      ...
      [Table,Col] = FITS.readTable1(EvtFile);
      %[~,~,~,Col,Table]=get_fitstable_col(EvtFile);
      D=tools.math.geometry.plane_dist(Table{Col.x},Table{Col.y},X,Y);
      I=find(D<InPar.Aper);
      Cnt = length(I);
      if (1==0)
      ...
      I=find(tools.cell.isempty_cell(strfind(CCDmapping(:,1),num2str(UnCCDID)))==0);
...
CCDmapping = {'0','ACIS-I0';'1','ACIS-I1';'2','ACIS-I2';'3','ACIS-I4';'4','ACIS-S0';'5','ACIS-S1';'6','ACIS-S2';'7','ACIS-S3';'8','ACIS-S4';'9','ACIS-S5'};
I=find(tools.cell.isempty_cell(strfind(CCDmapping(:,1),num2str(7)))==0);
DetSubSystem = CCDmapping{I,2};
