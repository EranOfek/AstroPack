function [BestRA, BestDec, BestAlt] = nearZenithFarFromMoon(JD, Args)
    ...
    MoonHA = celestial.convert.convert_ha(MoonRA, JD, 'Long',Long, 'InUnits','rad', 'OutRange','2pi', 'OutUnits','rad');  % [rad]
    ...
    AltZenithRA = celestial.convert.convert_ha(ZenithHA, JD, 'Long',Long, 'InUnits','rad', 'OutRange','2pi', 'OutUnits','rad');  % [rad]
