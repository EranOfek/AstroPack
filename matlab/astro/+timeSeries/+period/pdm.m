...
% Example: t=(1:1:1000)'; M=sin(2.*pi.*t./27.1)+randn(1000,1).*0.1; E=0.1.*ones(1000,1); P=timeSeries.period.pdm([t, M E],(0:0.0005:1)',10);
% Reliable: 
%------------------------------------------------------------------------------
...
for If=1:1:Nf
   ...
   B      = timeSeries.bin.binning([Phase,Data(:,Col.M)],BinSize,[0 1],{'MeanBin',@mean,@std,@numel});
...
%    
%    
%    [BFData] = timeSeries.bin.binning_old(Folded,1./BinNum,0,1);
% 
%    N   = BFData(:,7);
