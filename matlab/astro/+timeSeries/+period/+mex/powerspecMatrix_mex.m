% Fast calculation of the power spectrum for matrix, ignoring NaN, using MEX
%     The result is not normalized
% Input  : - A vector of times.
%          - A matrix of measurments. NaN will be ignored.
%          - A vector of frequencies for which to calculate the power
%            sperctrum.
% Output : - A matrix of the power spectrum per frequency, and per source.
...
% Example: PS=timeSeries.period.mex.powerspecMatrix_mex(T,M,FreqVec);