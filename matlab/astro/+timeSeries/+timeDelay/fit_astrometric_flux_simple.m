...
% Example: Res=timeSeries.timeDelay.fit_astrometric_flux_simple(...)
...
[Res.BestPar_H0,Res.LL_H0]=InPar.Solver({@timeSeries.timeDelay.chi2_xF, ...
                                         FitParH0,...
                                         'Limits', InPar.Limits,...
                                         't', InPar.t,...
                                         'F_t',InPar.F_t,...
...
for Itau=1:1:Ntau
    ...
    [Res.BestPar_H1(Itau,:),Res.LL_H1(Itau)]=InPar.Solver({@timeSeries.timeDelay.chi2_xF, ...
                                         FitParH1,...
                                         'Limits', InPar.Limits,...
                                         't', InPar.t,...
                                         'F_t',InPar.F_t,...
