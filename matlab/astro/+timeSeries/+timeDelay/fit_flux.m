...
%            'Solver' - Default is @tools.math.fit.fminunc_my (Requires MAAT)
...
% Example: Res=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat)
...
if InPar.InputFT
    ...
    freqs = timeSeries.timeDelay.fft_freq(N, Tstep(1));
    w = 2.*pi*freqs;
    w = w(:);
...
%Res.LL_H0 = timeSeries.timeDelay.logl_F(ParH0, FitParH0, InPar.Limits, InPar.Min_w, w, F_w, sigma_F);
...
if InPar.TimeDomain
    ...
    [Res.BestPar_H0,Res.LL_H0,Res.ExitFlag_H0]=InPar.Solver({@timeSeries.timeDelay.logl_F, ...
                                             'FitPar',FitParH0,...
                                             'Limits',Limits,...
                                             'Min_w',InPar.Min_w,...
                                             't',t,...
    ...
    for Itau=1:1:Ntau
        ...
        [Res.BestPar_H1(Itau,:),Res.LL_H1(Itau),Res.ExitFlag_H1(Itau)]=InPar.Solver({@timeSeries.timeDelay.logl_F, ...
                                            'FitPar',FitParH1,...
                                             'Limits',Limits,...
                                             'Min_w',InPar.Min_w,...
                                             't',t,...
