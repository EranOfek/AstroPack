...
if Tau<InPar.Limits(1,1) || Tau>InPar.Limits(1,2) || ...
    ...
    f_t = timeSeries.timeDelay.reconstruct_ft(InPar.F_t, InPar.x_t, x0, [x1, x2], A0, A1, InPar.ErrF_t, InPar.Errx_t);
    
    CalcF_t = timeSeries.timeDelay.combined_Ft(InPar.t, f_t, A0, [A1 A2], Tau, InPar.InterpMethod);
    ...
    ErrF_t = ErrF_t.*1;
    Chi2 = sum((Resid(Flag)./ErrF_t).^2, 1, 'omitnan');
