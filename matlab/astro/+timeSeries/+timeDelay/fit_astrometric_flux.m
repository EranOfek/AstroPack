...
% Example: Res=timeSeries.timeDelay.fit_astrometric_flux
%          ResF=timeSeries.timeDelay.timedelayed_lc;
% Res=timeSeries.timeDelay.fit_astrometric_flux(ResF.T,ResF.F_t,ResF.x_t,ResF.y_t,ResF.eps_F_abs,ResF.eps_x_abs);

% [ResLC]=timeSeries.timeDelay.rand_lensed;

% Res = timeSeries.timeDelay.fit_astrometric_flux(ResLC.T,ResLC.F_t,ResLC.x_t,ResLC.y_t,ResLC.sigma_F_hat,ResLC.sigma_x_hat);
...
for Itau=1:1:Ntau
    ...
    if InPar.TwoD
        ...
        [Res.BestPar_H1(Itau,:),Res.LL_H1(Itau),Res.ExitFlag_H1(Itau)]=InPar.Solver({@timeSeries.timeDelay.logl_x2d_given_F, ...
        ...
        [Res.BestPar_H0(Itau,:),Res.LL_H0(Itau),Res.ExitFlag_H0(Itau)]=InPar.Solver({@timeSeries.timeDelay.logl_x2d_given_F, ...
        ...
        [Res.BestPar_H1(Itau,:),Res.LL_H1(Itau),Res.ExitFlag_H1(Itau)]=InPar.Solver({@timeSeries.timeDelay.logl_xF, ...
                                         'FitPar',FitParH1,...
                                         'Limits',Limits,...
                                         'w',w,...
                                         't',t,...
        ...
        if Itau==1
            [Res.BestPar_H0(Itau,:),Res.LL_H0(Itau),Res.ExitFlag_H0(Itau)]=InPar.Solver({@timeSeries.timeDelay.logl_xF, ...
                                             'FitPar',FitParH0,...
                                             'Limits',Limits,...
                                             'w',w,...
                                             't',t,...
