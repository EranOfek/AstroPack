...
%          * Arbitrary pairs of arguments to pass to timeSeries.timeDelay.rand_lensed.
% Output : - A structure containing the simulated light curve.
%     By : Eran O. Ofek                  Oct 2020
% Example: T=timeSeries.rand.random_time_sequence; 
%          ResLC=timeSeries.timeDelay.rand_lensed_uneq(T);     
...
TotTime = range(T);
[Res]=timeSeries.timeDelay.rand_lensed(varargin{:},'sigma_F_rel',0,'sigma_x',0,'DeltaT',0.1,'TotTime',TotTime);
