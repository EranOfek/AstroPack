...
%            Default is 1000.
% Example : timeSeries.timeDelay.plots_for_paperI('a1a2');
...
switch lower(Plot)
    case 'ps'
        ...
        %[LogLikeF,Sigma_F,Sigma_phi]=timeSeries.timeDelay.logl_F(Pars, FitPar, [], Min_w, ResLC.w, ResLC.F_w, ResLC.sigma_F_hat);
        [LogLikeF,Sigma_F,Sigma_phi]=timeSeries.timeDelay.logl_F(Pars,'FitPar',FitPar,...
                    'Min_w',Min_w,...
                    'w',ResLC.w,...
                    'F_w',ResLC.F_w,...
        ...
        Res = timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'VecInvTau',1./InPar.Tau,'FitPar',FitPar,'DefPar',DefPar,...
                'Min_w',Min_w);

        [BLogLikeF,BSigma_F,BSigma_phi]=timeSeries.timeDelay.logl_F([InPar.Tau, Res.BestPar_H1],'FitPar',[InPar.Tau, Res.BestPar_H1],...
                    'Min_w',Min_w,...
                    'w',ResLC.w,...
                    'F_w',ResLC.F_w,...
                    'sigma_F',ResLC.sigma_F_hat);
        ...
        Res = timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,...
                'Min_w',Min_w);
    ...
    case 'a1a2'
        ...
        if IsFreq
            ...
            [LogLikeF_H0,Sigma_F,Sigma_phi]=timeSeries.timeDelay.logl_F(Pars,'FitPar',FitParH0,...
                                                                  'w',ResLC.w,...
                                                                  'F_w',ResLC.F_w,...
                                                                  'sigma_F',ResLC.sigma_F_hat);
            ...
            for Ia1=1:1:Na1
                ...
                for Ia2=1:1:Na2
                    ...
                    [LogLikeF_H1,Sigma_F,Sigma_phi]=timeSeries.timeDelay.logl_F(Pars,'FitPar',FitParH1,...
                                                                  'w',ResLC.w,...
                                                                  'F_w',ResLC.F_w,...
                                                                  'sigma_F',ResLC.sigma_F_hat);
            ...
            [LogLikeF_H0]=timeSeries.timeDelay.logl_F(Pars,'FitPar',FitParH0,...
                                                                  't',ResLC.T,...
                                                                  'F_t',ResLC.F_t,...
                                                                  'sigma_F',ResLC.sigma_F_hat);
            ...
            for Ia1=1:1:Na1
                ...
                for Ia2=1:1:Na2
                    ...
                    [LogLikeF_H1]=timeSeries.timeDelay.logl_F(Pars,'FitPar',FitParH1,...
                                                                  't',ResLC.T,...
                                                                  'F_t',ResLC.F_t,...
                                                                  'sigma_F',ResLC.sigma_F_hat,...
                                                                  'G1',G1,...
    ...
    case 'compare_ft_methods'
        ...
        % G0=0
        tic;
        Res1(Isim)=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar);
        toc
        
        % with w0=1/1000
        tic;
        Res2(Isim)=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,'w0',1./1000);
        toc
        % with w0=1/10000
        tic;
        Res3(Isim)=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,'w0',1./10000);
        toc
    ...
    case 'test_ft'
        ...
        for Isim=1:1:Nsim
            ...
            tic;
            Res(Isim)=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar);
            toc
        end
        ...
        for Isim=1:1:Nsim
            ...
            tic;
            ResFS(Isim)=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',false,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar);
            toc
        end
    ...
    case 'test_ft_a2'
        ...
        for Isim=1:1:Nsim
            ...
            [Isim,2]
            tic;
            Res2(Isim)=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar);
            toc
        end
        ...
        for Isim=1:1:Nsim
            ...
            [Isim,3]
            tic;
            Res3(Isim)=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar);
            toc
        end
    ...
    case 'time_h0'
        ...
        for Ig=1:1:Ng
            ...
            for Isim=1:1:Nsim
                ...
                Res(Ig,Isim) = timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,...
    ...
    case 'fitgamma'
        ...
        for Isim=1:1:Nsim
            ...
            Res(Isim) = timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,...
    ...
    case 'vargamma'         
        ...
        for Ig=1:1:Ng
            ...
            for Isim=1:1:Nsim
                ...
                Res(Ig,Isim) = timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,...
                    'Min_w',[2.*pi./5000 2.*pi./0.01]);
    ...
    case 'wronggamma'            
        ...
        for Ig=1:1:Ng
            ...
            for Isim=1:1:Nsim
                ...
                Res(Ig,Isim) = timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,'Min_w',Min_w);
    ...
    case 'varsigmaf'
        ...
        for Ig=1:1:Ng
            ...
            for Isim=1:1:Nsim
                ...
                Res(Ig,Isim) = timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,'Min_w',[2.*pi./5000 2.*pi./0.01]);
    ...
    case 'td_uneq'
        ...
        for Isim=16:1:Nsim
            ...
            %ResLC.T   = TT;
            tic;
            Res(Isim) = timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,...
                                                            'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar);
...
%             MinNT = min(NTsec);
            for Isec=1:1:Nsec
                ResA(Isec,Isim) = timeSeries.timeDelay.fit_flux(Section(Isec).OmegaVec(:),Section(Isec).FT,Section(Isec).Err(1),'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,...
                                    'Min_w',Min_w,...
                                    'InputFT',true);
...
%                 Err  = Section(1).Err(1);
           ...
           ResC(Isim) = timeSeries.timeDelay.fit_flux(PS.OmegaVec(:),PS.FT,Section(1).Err(1),'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,...
                                    'Min_w',Min_w,...
                                    'InputFT',true);
...
'a'
    ...
    case 'uneq_ztf'
        ...
        for Isim=1:1:Nsim
            ...
            Res0(Isim)=timeSeries.timeDelay.fit_flux(ResLC.T,ResLC.F_t,ResLC.sigma_F_hat,'TimeDomain',true,'VecInvTau',VecInvTau,'FitPar',FitPar,'DefPar',DefPar,'Min_w',Min_w);
...
%     ResLC=timeSeries.timeDelay.rand_lensed_uneq(T,InPar);
%     
%     N = numel(T);
%     LC = [ResLC.T, ResLC.F_t, ResLC.Base.sigma_F_hat.*ones(N,1)];
%     [PS,Section]=timeSeries.timeDelay.power_spectrum_sections(LC);
