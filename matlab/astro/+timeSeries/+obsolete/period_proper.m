...
if (nargin==0)
    ...
    Period = 12.3;
    Time = (0:1:200).';
    Time = timeseries.rand.random_time_sequence;
    Time = Time(Time<500);
...
Nd = size(Data,1);
WhC = timeSeries.period.period_complex([Data(:,1),ones(Nd,1)],FreqVecAll,'amp',false);  
Wh  = timeSeries.period.period_normnl([Data(:,1),ones(Nd,1)],FreqVecAll,'amp',false);
