...
switch lower(InPar.BinMethod)
    case 'number'
        ...
        Bin = timeSeries.bin.binning([Flux,RMS],Edges,[],{'MidBin',@numel,InPar.MeanFun,InPar.StdFun});
        Nbin = size(Bin,1);
    ...
    case 'flux'
        Bin = timeSeries.bin.binning([Flux,RMS],InPar.FluxBinSize,[],{'MidBin',@numel,InPar.MeanFun,InPar.StdFun});
