function CalStars = calibrationStars(Args)
    ...
    tab = readtable('coord_sptype.csv');
    ...
    for Isrc=1:1:NHi
        ...
        Fname = sprintf('specs_513_fits/%s.fits',hcad.obj{Isrc});
...
%         pause;   
    ...
    for Isrc=1:1:NLo
        ...
        Fname = sprintf('specs_513_fits/%s.fits',lcad.obj{Isrc});
        Ftab  = fitsread(Fname,'binarytable');
        Sp = [Ftab{1} Ftab{6} Ftab{7}];
...
%         Name = sprintf('V=%.2f V0=%.2f U(R1)=%.2f',MagV(Isrc),MagV0(Isrc),MagU1l(Isrc)); title(Name)
    ...
    % plot the ULTRASAT magnitudes and SNR ratio of the high-cadence starss
    ...
    title 'high cadence STISNGSL stars'; legend('Location', 'best');
    ...
    title 'low cadence STISNGSL stars'; 
    ylabel 'ULTRASAT R1 magn'; xlabel 'l, deg';
