#!/bin/bash
# ============================================================
#  Start MATLAB TooPlanner Service in tmux session
# ============================================================

SESSION="soc_too_planner_matlab"
SCRIPT_PATH="$ASTROPACK_PATH/matlab/astro/+ultrasat/services/too_planner_service/run_soc_too_planner_matlab.sh"
