...
function soc_slew_calc_worker_matlab()
    ...
    if isdeployed
        fprintf('soc_slew_calc_worker_matlab: isdeployed = TRUE\n');
        locate_externapp = which(fullfile('soc_slew_matlab.exe'));
        fprintf('which: %s\n', locate_externapp);
    end    
    
    if ismcc
        fprintf('soc_slew_calc_worker_matlab: ismcc = TRUE\n');
    end           
    ...
    fprintf('soc_slew_calc_worker_matlab done\n');
end
