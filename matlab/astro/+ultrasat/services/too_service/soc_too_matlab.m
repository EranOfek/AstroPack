...
%       to the folder of this file (i.e. app_too/)
%==========================================================================
...
function soc_too_matlab()
    ...
    if isdeployed
        fprintf('soc_too_matlab: isdeployed = TRUE\n');
        locate_externapp = which(fullfile('soc_too_matlab.exe'));
        fprintf('which: %s\n', locate_externapp);
    end    
    
    if ismcc
        fprintf('soc_too_matlab: ismcc = TRUE\n');
    end           
    ...
    if isdeployed
        ...
        FMap.StorageFileName = fullfile(SOC_PATH, 'too', 'too_matlab', 'AstroPackFileMap_1.mat');
        FMap.loadMap();    
    ...
    %try
        ...
        %end
    %catch
        %fprintf('soc_too_matlab exception\n');
    %end
    
    fprintf('soc_too_matlab done\n');
end
