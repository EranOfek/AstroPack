...
% File        : ultrasat.api.utils.LogManager.m
% Author      : Chen Tishler
% Created     : 16/10/2025
% Updated     : 20/10/2025
...
classdef LogManager
    ...
    methods (Static)
        function registerLoggerApps(loggerApp, errorLoggerApp)
            ...
            ultrasat.api.utils.LogManager.persistentLoggerApp(loggerApp);
            ultrasat.api.utils.LogManager.persistentErrorLoggerApp(errorLoggerApp);
        end


        function logMessage(message)
            % Forward message to LoggerApp, if available
            loggerApp = ultrasat.api.utils.LogManager.persistentLoggerApp();
        ...
        function logError(message)
            ...
            errorLoggerApp = ultrasat.api.utils.LogManager.persistentErrorLoggerApp();
