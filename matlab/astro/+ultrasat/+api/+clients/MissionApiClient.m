...
classdef MissionApiClient < ultrasat.api.clients.MissionApiBase
    ...
    methods
        function obj = MissionApiClient(Args)
            ...
            obj@ultrasat.api.clients.MissionApiBase(baseArgsCell{:});
            ...
            obj.Client = ultrasat.api.clients.ClientBase(...
                'BaseUrl', baseUrl, ...
                'SubUrl', Args.SubUrl, ...
                'ApiKey', apiKey, ...
        ...
        function response = loadPlan(obj, plan_pk)
            ...
            obj.PlanData = ultrasat.api.models.PlanData.fromStruct(matlabPlan);
