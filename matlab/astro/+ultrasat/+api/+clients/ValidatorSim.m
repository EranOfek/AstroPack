...
classdef ValidatorSim < ultrasat.api.core.Loggable
    ...
    methods
        ...
        function response = newResponse(obj)
            ...
            response = struct(...
                'validation_time', ultrasat.api.utils.ModelBase.nowUtc(), ...
        ...
        function task = newResponseTask(obj, targets, target_results)
            ...
            task = struct(...
                'task_id', sprintf('tsk_%s', datestr(ultrasat.api.utils.ModelBase.nowUtc, 'yyyymmddHHMMSS')), ...
        ...
        function targets = generateTargetResults(obj, targets)
            ...
            for i = 1:numel(targets)
                ...
                if warn
                    targets(i).warning = struct(...
                        'time', datestr(ultrasat.api.utils.ModelBase.nowUtc, 'yyyy-mm-ddTHH:MM:SS.FFFZ'), ...
                        'duration', '100', ...
        ...
        function appendValidationToDb(obj, targets, response)
            ...
            validationEntry = struct(...
                ...
                'timestamp', ultrasat.api.utils.ModelBase.nowUtcStr(), ...
                'input', targets, ...
                'output', response ...
            );
