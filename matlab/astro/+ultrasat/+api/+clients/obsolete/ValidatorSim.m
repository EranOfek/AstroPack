...
classdef ValidatorSim < ultrasat.api.core.Loggable
    ...
    methods
        ...
        function task = newResponseTask(obj, targets, target_results)
            ...
            task = struct(...
                'task_id', sprintf('tsk_%s', datestr(ultrasat.api.utils.DateTimeUtils.nowUtc(), 'yyyymmddHHMMSS')), ...
        ...
        function targets = generateTargetResults(obj, targets)
            ...
            for i = 1:numel(targets)
                ...
                if warn
                    targets(i).warning = struct(...
                        'time', datestr(ultrasat.api.utils.DateTimeUtils.nowUtc(), 'yyyy-mm-ddTHH:MM:SS.FFFZ'), ...
                        'duration', '100', ...
        ...
        function appendValidationToDb(obj, targets, response)
            ...
            validationEntry = struct(...
                ...
                'timestamp', ultrasat.api.utils.DateTimeUtils.nowUtcStr(), ...
                'input', targets, ...
                'output', response ...
            );
