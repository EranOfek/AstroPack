...
function debug_MissionModels()
    % Main function to debug ultrasat.api.MissionModels functionality.
...
function debugNewImagingTarget()
    ...
    target = ultrasat.api.MissionModels.newImagingTarget();
...
function debugNewEmptyPlanStruct()
    ...
    planStruct = ultrasat.api.MissionModels.newEmptyPlanStruct();
...
function debugToUtc()
    ...
    dt_converted = ultrasat.api.MissionModels.toUtc(dt_str);
    disp(dt_converted);

    fprintf('Converting datetime to UTC:\n');
    dt_converted = ultrasat.api.MissionModels.toUtc(dt_obj);
    disp(dt_converted);
end
