classdef RefImagesTable < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        RefImagesNOTIMPLEMENTEDYETLabel  matlab.ui.control.Label
    end
    ...
    methods (Access = private)
        ...
        function HelpButtonPushed(app, event)
            app.MainModule.MainApp.showHelp('ref_images');
        end
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create RefImagesNOTIMPLEMENTEDYETLabel
            app.RefImagesNOTIMPLEMENTEDYETLabel = uilabel(app.Panel_2);
            app.RefImagesNOTIMPLEMENTEDYETLabel.HorizontalAlignment = 'center';
            app.RefImagesNOTIMPLEMENTEDYETLabel.FontSize = 18;
            app.RefImagesNOTIMPLEMENTEDYETLabel.FontWeight = 'bold';
            app.RefImagesNOTIMPLEMENTEDYETLabel.Position = [8 1 1298 33];
            app.RefImagesNOTIMPLEMENTEDYETLabel.Text = 'RefImages - NOT IMPLEMENTED YET';
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = RefImagesTable(varargin)
