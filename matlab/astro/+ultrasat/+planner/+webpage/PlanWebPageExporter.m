...
classdef PlanWebPageExporter
    ...
    properties
        PlanId              % Unique numeric ID for the plan
    ...
    methods
        function obj = PlanWebPageExporter(planId, outputBaseFolder, templatePath, debugMode)
            ...
            obj.PlanId = planId;
            obj.OutputFolder = fullfile(outputBaseFolder, sprintf("plan_%d_web", planId));
        ...
        function obj = generateHtmlFromTemplate(obj)
            ...
            % Replace plan ID
            html = strrep(html, '{{plan_id}}', num2str(obj.PlanId));
