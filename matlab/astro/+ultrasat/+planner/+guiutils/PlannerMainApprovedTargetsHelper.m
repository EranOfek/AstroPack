        ...
        function showApprovedTargets(obj, app)
            ...
            try
                ...
                app.ApprovedTargetsPanel.Title = sprintf('Approved Targets: (%s - %s)  - Retrieved: %s', ...
                    ultrasat.api.utils.ModelBase.datetimeStr(app.MainModule.ApiClient.ApprovedTargetsStartTime), ...
                    ultrasat.api.utils.ModelBase.datetimeStr(app.MainModule.ApiClient.ApprovedTargetsEndTime), ...
                    ultrasat.api.utils.ModelBase.datetimeStr(app.MainModule.Planner.RetrivedMissionTime));
