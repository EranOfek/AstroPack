...
% File        : ultrasat.planner.debug.debug_Too.m
% Author      : Chen Tishler
% Created     : 31/05/2026
% Description : Step-by-step debug for TOO (Target of Opportunity) plans.
%               Code paths mirror uplanner.unitTest TOO block.
%               Uses +debug/input_data/ LVK probability map fixture.
% Run by      : ultrasat.planner.debug.debug_Too()
%==========================================================================
...
function csvPath = debug_getLvcCsvPath()
    ...
    fprintf('Copy lvc_2024_04_01_00_40_58_000000.csv into +debug/input_data/.\n');
    csvPath = '';
end
