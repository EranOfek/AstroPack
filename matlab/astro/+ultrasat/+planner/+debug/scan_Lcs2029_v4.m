...
% File        : ultrasat.planner.debug.scan_Lcs2029_v4.m
% Author      : Chen Tishler
% Created     : 08/06/2026
% Updated     : 08/06/2026
% Description : Scan all 2029 LCS start dates with LcsHelper_v4 only.
%
% Run by:
%   ultrasat.planner.debug.scan_Lcs2029_v4()
%
% Useful shorter test:
%   ultrasat.planner.debug.scan_Lcs2029_v4( ...
...
function scan_Lcs2029_v4(Args)
    ...
    if isempty(Args.OutputDir)
        Args.OutputDir = fullfile(ThisDir, 'lcs_2029_scan', 'v4');
    end
