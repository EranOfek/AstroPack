classdef PlanParams < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function BuildStatusButtonPushed(app, event)
            app.MainModule.MainApp.BuildHelper.showBuildStatusWindow();
        end

        % Button pushed function: ValidationStatusButton
        function ValidationStatusButtonPushed(app, event)
            app.MainModule.MainApp.SubmitHelper.showValidationStatusWindow();
        end
        ...
        function SaveButtonPushed(app, event)
            ...
            try
                ...
                app.MainModule.MainApp.PlanParamsHelper.applyPlanParams(app);
                app.Status = 'Save';
                uiresume(app.UIFigure);                                        
            catch ME
        ...
        function SubmitStatusButtonPushed(app, event)
            app.MainModule.MainApp.SubmitHelper.showSubmitStatusWindow();
        end
