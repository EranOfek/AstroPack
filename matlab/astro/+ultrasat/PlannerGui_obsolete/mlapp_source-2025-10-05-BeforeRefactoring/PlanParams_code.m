classdef PlanParams < matlab.apps.AppBase
    ...
    methods (Access = public)
        ...
        function beforeShow(app)
            ...
            % If plan was built (i.e. not empty)
            IsPlanEmpty = height(app.MainModule.Planner.Plan) == 0;

            % Editable only when plan is not empty            
            Set = true;
            if Set
    ...
    methods (Access = private)
        ...
        function BuildStatusButtonPushed(app, event)
            app.MainModule.MainApp.showBuildStatusWindow();
        end

        % Button pushed function: ValidationStatusButton
        function ValidationStatusButtonPushed(app, event)
            app.MainModule.MainApp.showValidationStatusWindow();
        end
        ...
        function CheckTimesUpdateButtonPushed(app, event)
            % Apply changes
            app.MainModule.MainApp.applyCheckTimes(app);            
        end
        ...
        function SaveButtonPushed(app, event)
            ...
            try
                % Call PlannerMain.doApplyPlanParams()
                app.MainModule.MainApp.doApplyPlanParams(app);
                app.Status = 'Save';
                uiresume(app.UIFigure);                                        
            catch ME
                app.MainModule.MainApp.msgex('showPlanParamsWindow', ME);
            end                                
        end
        ...
        function SubmitStatusButtonPushed(app, event)
            app.MainModule.MainApp.showSubmitStatusWindow();
        end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.TitleEditField.Position = [91 216 352 22];
