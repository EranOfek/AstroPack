function Result = fieldCorrection(Coords, ParamMatrix, Args)
    ...
    %          Corrections = astro.transmission.fieldCorrection(Coords, Params);
    %          % Use with CompositeFun
    %          TransFun = tools.math.fun.CompositeFun();
    %          TransFun.addFun('FieldCorrection', @astro.transmission.fieldCorrection, [], ...
