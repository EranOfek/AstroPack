...
%      celestial.Kepler.unitTest - unitTest for celestial.Kepler
%  celestial.Kepler.xyz2elements - Convert rectangular heliocentric ecliptic coo. and vel. to orbital elements.
% celestial.SolarSys.aberrationSolarSystem - Apply aberration of light to solar system observer and body
...
% celestial.SolarSys.getJPL_smallBodyByCoo - Search for small bodies near position and time using JPL horizons
...
% celestial.SolarSys.orbitIntegration - Calculate the position and velocity evolution for a list of bodies
% celestial.SolarSys.orbitIntegrationLightTime - 
% celestial.SolarSys.orbitIntegrationLightTime1 - 
...
%   celestial.SolarSys.ple_force - Calculate the net Sun+planets G*M on a solar system body.
...
%    celestial.SolarSys.unitTest - Unit-Test for celestial.SolarSys
...
% celestial.coo.convert2equatorial - Convert coordinates/name to apparent equatorial coordinates. OBSOLETE -
...
%     celestial.coo.coo_resolver - Resolve coordinates or target name into RA/Dec - OBSOLETE: use celestial.convert.cooResolve
...
% celestial.coo.refraction_coocor - Atmospheric refraction correction for equatorial coordinates. OBSOLETE: celestial.convert.refractedCoo
...
% celestial.coo.sphere_dist_fast_threshDist - Fast spherical angular distance calculation with distance threshold (no calculation above threshold)
...
%         celestial.coo.unitTest - Unit Test for celestial.coo
...
%         celestial.htm.unitTest - unitTest for celestial.htm
...
%        celestial.proj.unitTest - unitTest for celestial.proj
...
%           celestial.time.isUTC - (Linux only) Check if computer time zone is UTC
...
%        celestial.time.unitTest - unitTest for celestial.time
...
%            celestial.KDTreeCoo - celestial.KDTreeCoo class
%             celestial.perfTest - performence tests for celestial.KDTreeCoo
%             celestial.unitTest - celestial.KDTreeCoo.unitTest
