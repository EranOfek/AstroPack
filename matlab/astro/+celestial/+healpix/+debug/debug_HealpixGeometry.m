%==========================================================================
% Project     : AstroPack
% File        : +celestial/+healpix/+debug/debug_HealpixGeometry.m
% Author      : Chen Tishler
% Created     : 17/06/2026
% Modified    : 17/06/2026
% Description : Debug geometry, rasterize, and plot functions in
%               celestial.healpix: healpixVertices, isInside, pixBoundries,
%               rasterize_polygon, mex.rasterize_polygon, plot.
%==========================================================================

function debug_HealpixGeometry()
    % Smoke-test healpix geometry, rasterize, and plot helpers.
