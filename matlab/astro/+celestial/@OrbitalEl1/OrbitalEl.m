...
classdef OrbitalEl < Base
    ...
    methods % Keplerian orbit functions
        ...
        function Result = period(Obj, Units)
            ...
            %            For parabolic/hyperbolic orbits the period is
            %            calculated using abs(A).
    ...
    methods % ephemerides
        ...
        function Result = ephem(Obj, Time, Args)
            ...
            %          
            %          OrbEl = celestial.OrbitalEl.loadSolarSystem('unnum','A/2017 U1'); % hyperbolic
            %          Cat = ephem(OrbEl, JD)
            %          
        ...
        function Result = searchMinorPlanetsNearPosition(Obj, JD, RA, Dec, SearchRadius, Args)
            ...
            ObjNew = Obj.copy;   % much faster - shallow copy
