% Above threshold spherical distance using the havesine formula (fast mex)
%     Spherical distance will be calculated only for when
%     dlon/dlat>Threshold (should take care over wrapping).
...
%          tic; for I=1:1e4, dd=celestial.coo.mex.haversineThresh_ScalarArray(1,1,R3,R4); end,toc
