...
Display images in ds9 (use ds9 for short cut) Package: @ds9 Description: Display images in ds9 For shortcut use the ds9 constructor
...
Get the pixel values in a specified box region Package: @ds9 getbox function                                                          ds9
...
Interactively get the coordinates (WCS) Package: @ds9 Description: Interactively get the coordinates (WCS) and value of the pixel selected by the mouse (left click) or by clicking
...
Interactively get the coordinates (X/Y or WCS) Package: @ds9 Description: Interactively get the coordinates (X/Y or WCS) and value of the pixel selected by the mouse (left click) or by clicking
...
Interactively plot a line Package: @ds9 Description: Interactively plot a line in ds9 between two points defined by mouse left clicks.
...
Interactive plot symbols Package: @ds9 Description: Interactive plot symbols in right click coordinates. Use 'q' click to abort.
...
Interactively plot a polygon Package: @ds9 Description: Interactively plot a polygon. Verteces are defined by mouse or keybord clicks.
...
Open NED link for clicked position Package: @ds9 Description: Click on a position in an image displayed in ds9 and this program will open the NED coordinate search web page for the
...
Generate and plot a region file from a list of coordinates Package: @ds9 Description: Generate and plot a region file from a list of coordinates.
...
Example: ds9.plotXY([X, Y],[], 'wo','MarkerSize',18,'Marker','s', 'CooType','icrs'); ds9.plotXY(AstroCatalog, 'ro', 'MarkerSize',18, 'ColNameX','X','ColNameY','Y');
...
Open SDSS navigator for clicked position Package: @ds9 Description: Click on a position in an image displayed in ds9 and this program will open the SDSS navigator web page for the
...
Interactively get values from SIM images Package: @ds9 Description: Interactively get values from SIM images (image, background, error, weight and mask) at clicked
