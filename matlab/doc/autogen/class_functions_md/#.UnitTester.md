...
Add warning message to Obj.WarnList
...
Return full file name to package.class or package.func
...
Return true if specified file should be processed by checking that name does not contain word that means an excluded file (such as 'obsolete')


    
    Return true if specified file should be processed by checking  
    that name does not contain word that means an excluded file  
    (such as 'obsolete')  
...
Dummy function, just to avoid warnings about missing unitTest
