function tests = test_mexHealpix
    % Direct unit tests for celestial.healpix.mex wrappers.
...
function testRasterizePolygonMexSmoke(testCase)
    ...
    celestial.healpix.HealpixTestHelper.assumeMex(testCase, 'rasterize_polygon');
