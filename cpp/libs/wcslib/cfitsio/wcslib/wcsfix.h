...
// @Chen
CFITS_API const char** get_wcsfix_errmsg();
...
int CFITS_API wcsfix(int ctrl, const int naxis[], struct wcsprm *wcs, int stat[]);

int CFITS_API wcsfixi(int ctrl, const int naxis[], struct wcsprm *wcs, int stat[],
            struct wcserr info[]);
