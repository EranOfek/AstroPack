...
// @Chen
CFITS_API const char** get_wcshdr_errmsg();
...
int CFITS_API wcspih(char *header, int nkeyrec, int relax, int ctrl, int *nreject,
           int *nwcs, struct wcsprm **wcs);

int CFITS_API wcsbth(char *header, int nkeyrec, int relax, int ctrl, int keysel,
           int *colsel, int *nreject, int *nwcs, struct wcsprm **wcs);

int CFITS_API wcstab(struct wcsprm *wcs);

int CFITS_API wcsidx(int nwcs, struct wcsprm **wcs, int alts[27]);

int CFITS_API wcsbdx(int nwcs, struct wcsprm **wcs, int type, short alts[1000][28]);

int CFITS_API wcsvfree(int *nwcs, struct wcsprm **wcs);

int CFITS_API wcshdo(int ctrl, struct wcsprm *wcs, int *nkeyrec, char **header);
