...
void CFITS_API wcsdealloc(void *ptr);

void CFITS_API wcsutil_strcvt(int n, char c, const char src[], char dst[]);

void CFITS_API wcsutil_blank_fill(int n, char c[]);
void CFITS_API wcsutil_null_fill (int n, char c[]);

int  CFITS_API wcsutil_allEq (int nvec, int nelem, const double *first);
int  CFITS_API wcsutil_Eq(int nelem, double tol, const double *arr1,
                const double *arr2);
int  CFITS_API wcsutil_intEq(int nelem, const int *arr1, const int *arr2);
int  CFITS_API wcsutil_strEq(int nelem, char (*arr1)[72], char (*arr2)[72]);
void CFITS_API wcsutil_setAll(int nvec, int nelem, double *first);
void CFITS_API wcsutil_setAli(int nvec, int nelem, int *first);
void CFITS_API wcsutil_setBit(int nelem, const int *sel, int bits, int *array);
CFITS_API char* wcsutil_fptr2str(void (*fptr)(void), char hext[19]);
void CFITS_API wcsutil_double2str(char *buf, const char *format, double value);
int  CFITS_API wcsutil_str2double(const char *buf, double *value);
int  CFITS_API wcsutil_str2double2(const char *buf, double *value);
