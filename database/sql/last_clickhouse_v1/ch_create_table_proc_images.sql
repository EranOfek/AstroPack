/*
  ...
  Title: ClickHouse SQL Script - Create Table: Proc Images
...
CREATE TABLE IF NOT EXISTS $db_name.proc_images
(
	--- Primary key columns
	proc_img_id		UInt64,		--- Unique image ID, generated in bitfields.py


	--- File
	raw_img_id		UInt64,		--- Unique raw image ID, generated in bitfields.py
	filename		String,
	xxhash			String,
	...
	INDEX idx_raw_img_id	(raw_img_id)	TYPE minmax GRANULARITY 16
)
