...
#
#   SQLite:
#       Auto-Increment/Row-Id   - https://www.sqlitetutorial.net/sqlite-autoincrement/
#
#
...
field_lang_dict = { \
    ...
    # Auto increment (32-bit or 64-bit?) @Todo - need to decide or allow both options
    'autoinc': {
        'postgres': 'SERIAL',
        'firebird': 'generated by default as identity',     # @Todo - need to be tested, Firebird 3.0 and above
        'sqlite': 'INTEGER',                                # @Todo - need to be tested,
        'python': 'int',
        'cpp': 'int',
        'delphi': 'Integer',
        'matlab': 'int32',
...
def get_field_type_lang(field_name, text, lang):
    ...
    if text == '' or text == 'double' or text == 'float' or text == 'real':
        ...
        text = 'bool'
    elif text == 'int' or text == 'int8' or text == 'int16' or text == 'int32' or text == 'integer':
        text = 'int'
        default_value = 0
...
class Field:
    ...
    def __init__(self):
        ...
        self.display_name = ''
        self.display_format = ''
        self.default_value = None           # @Todo (24/01/2022)
