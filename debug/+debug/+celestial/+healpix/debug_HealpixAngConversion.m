function debug_HealpixAngConversion()
    % debug_HealpixAngConversion  Debug mex-backed coordinate conversion.
    % Package: celestial.healpix.debug
    % Description: Smoke-test ang2pix and pix2ang (nested/ring, deg/rad,
    %              UniqueID).
    % Author : Chen Tishler (Jun 2026)
    % Run by: debug.celestial.healpix.debug_HealpixAngConversion
