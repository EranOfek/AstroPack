function debug_HealpixIndexing()
    % debug_HealpixIndexing  Debug nested indexing and resolution conversion.
    % Package: celestial.healpix.debug
    % Description: Smoke-test nest2xyf, xyf2nest, increasePixelResolution,
    %              decreasePixelResolution, convertHealPixNsideNested,
    %              convertHealPix2highNsideNested.
    % Author : Chen Tishler (Jun 2026)
    % Run by: debug.celestial.healpix.debug_HealpixIndexing
