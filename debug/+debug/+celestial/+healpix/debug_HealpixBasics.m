function debug_HealpixBasics()
    % debug_HealpixBasics  Debug small scalar utilities in celestial.healpix.
    % Package: celestial.healpix.debug
    % Description: Smoke-test nPix, nRing, pixRadius, radius2NSide,
    %              latitudeRings, pix2uniqueId, uniqueId2pix,
    %              pixelSons_nested.
    % Author : Chen Tishler (Jun 2026)
    % Run by: debug.celestial.healpix.debug_HealpixBasics
