function debug_HealpixConeSearch()
    % debug_HealpixConeSearch  Debug cone search functions in celestial.healpix.
    % Package: celestial.healpix.debug
    % Description: Smoke-test coneSearch, coneSearchRecur,
    %              coneSearch2PixRanges, mex.coneSearch.
    % Author : Chen Tishler (Jun 2026)
    % Run by: debug.celestial.healpix.debug_HealpixConeSearch
