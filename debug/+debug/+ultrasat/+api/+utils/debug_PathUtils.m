...
% Filename    : +debug/+ultrasat/+api/+utils/debug_PathUtils.m
% Author      : Chen Tishler
% Created     : 01/12/2024
% Updated     : 18/02/2026
% Description : Debugging function for PathUtils class.
%
% Run by      : debug.ultrasat.api.utils.debug_PathUtils()
%==========================================================================
function debug_PathUtils()
    % debug_PathUtils - A comprehensive test script for the PathUtils class.

    import ultrasat.api.utils.PathUtils;
