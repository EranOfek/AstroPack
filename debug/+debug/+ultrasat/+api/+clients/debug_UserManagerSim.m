...
% Filename    : +debug/+ultrasat/+api/+clients/debug_UserManagerSim.m
% Author      : Chen Tishler
% Created     : 01/12/2024
% Updated     : 18/02/2026
% Description : Debugging function for UserManagerSim class.
%
% Run by      : debug.ultrasat.api.clients.debug_UserManagerSim()
%==========================================================================

function debug_UserManagerSim()
    % Comprehensive test script for the UserManagerSim class.
