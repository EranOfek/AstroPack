%==========================================================================
% Filename    : +debug/+ultrasat/+api/+clients/obsolete/debug_ApiSimProvider.m
% Description : Debug driver for debug_ApiSimProvider
% Run by      : debug.ultrasat.api.clients.debug_ApiSimProvider()
%==========================================================================
...
function debug_TestLocal()
    ...
    fprintf('    Target: %s\n', LOCAL_BASE_PATH);
    try
        localProvider = ultrasat.api.clients.ApiSimProvider('', '');  %LOCAL_BASE_PATH);
...
function debug_TestRemote()
    ...
    fprintf('    Base Path: %s\n', REMOTE_BASE_PATH);
    try
        remoteProvider = ultrasat.api.clients.ApiSimProvider(REMOTE_URL, REMOTE_BASE_PATH);
