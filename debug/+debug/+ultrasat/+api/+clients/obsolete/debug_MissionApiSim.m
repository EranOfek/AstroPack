...
% Filename    : +debug/+ultrasat/+api/+clients/obsolete/debug_MissionApiSim.m
% Author      : Chen Tishler
% Created     : 18/06/2026
% Updated     : 18/06/2026
% Description : Debug driver for debug_MissionApiSim
%
% Run by      : debug.ultrasat.api.clients.debug_MissionApiSim()
%==========================================================================
...
function debug_MissionApiSim()
    ...
    clientSim = ultrasat.api.clients.MissionApiSim();   % 'DbPath', DbPath);
...
function debugSavePlan(clientSim)
    ...
    newPlan = ultrasat.api.models.PlanData();
