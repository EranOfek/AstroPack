%==========================================================================
% Filename    : +debug/+ultrasat/+api/+clients/obsolete/debug_SimpleFileClient.m
% Description : Debug driver for debug_SimpleFileClient
% Run by      : debug.ultrasat.api.clients.debug_SimpleFileClient()
%==========================================================================
function debug_SimpleFileClient()
    ...
    % --- Instantiate Client ---
    client = ultrasat.api.clients.SimpleFileClient(SERVER_URL, BASE_PATH);
