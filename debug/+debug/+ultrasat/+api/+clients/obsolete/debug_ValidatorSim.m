%==========================================================================
% Filename    : +debug/+ultrasat/+api/+clients/obsolete/debug_ValidatorSim.m
% Description : Debug driver for debug_ValidatorSim
% Run by      : debug.ultrasat.api.clients.debug_ValidatorSim()
%==========================================================================
