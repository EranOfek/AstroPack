...
% Filename    : +debug/+ultrasat/+api/+clients/debug_ClientBase.m
% Author      : Chen Tishler
% Created     : 01/12/2024
% Updated     : 18/02/2026
% Description : Debugging function for ultrasat.api.ClientBase class.
%
% Run by      : debug.ultrasat.api.clients.debug_ClientBase()
%==========================================================================
%
...
function debug_ClientBase()
    ...
    client = ultrasat.api.clients.ClientBase('BaseUrl', 'http://127.0.0.1:8299');
    client.ApiKey = [];
