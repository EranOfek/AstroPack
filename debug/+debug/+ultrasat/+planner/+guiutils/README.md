...
debug.ultrasat.planner.guiutils.debug_login()
```

Headless:

```powershell
matlab -batch "debug.ultrasat.planner.guiutils.debug_MainModule()" 2>&1
```
...
- API client debug: [[../../+api/+clients/README|debug API clients]]
- Planner core debug: [[../README|planner debug README]]
