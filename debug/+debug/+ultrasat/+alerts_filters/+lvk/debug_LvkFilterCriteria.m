...
% Filename    : +debug/+ultrasat/+alerts_filters/+lvk/debug_LvkFilterCriteria.m
% Author      : Chen Tishler
% Created     : 09/02/2026
% Updated     : 12/05/2026
% Description : Debug script for ultrasat.alerts_filters.lvk.models.LvkFilterCriteria
%
% Run by      : debug.ultrasat.alerts_filters.lvk.debug_LvkFilterCriteria()
%==========================================================================

function debug_LvkFilterCriteria()
    % Debug script for LvkFilterCriteria: constructors, serialization, file I/O.
...
function debugSaveLoadJsonFile()
    ...
    loaded = ultrasat.alerts_filters.lvk.models.LvkFilterCriteria.loadFromJsonFile(filePath);
    delete(filePath);
...
function debugErrorCases()
    ...
    try
        ultrasat.alerts_filters.lvk.models.LvkFilterCriteria("bns_min", 0.5, "far_max");
    ...
    % Unknown property
    try
        ultrasat.alerts_filters.lvk.models.LvkFilterCriteria("bns_min", 0.5, "unknown_prop", 1);
