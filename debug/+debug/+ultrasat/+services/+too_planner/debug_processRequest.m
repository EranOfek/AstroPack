...
% Filename    : +debug/+ultrasat/+services/+too_planner/debug_processRequest.m
% Author      : Chen Tishler
% Created     : 02/11/2025
% Modified    : 17/05/2026
...
%
% Run by      : debug.ultrasat.services.too_planner.debug_processRequest()
%==========================================================================
...
function csvPath = debug_getLvcCsvPath()
    ...
    if ~isfile(csvPath)
        error(['debug_getLvcCsvPath: fixture not found: %s\n' ...
            'Copy lvc_2024_04_01_00_40_58_000000.csv into debug/+debug/+ultrasat/+planner/input_data/.'], csvPath);
    end
end
