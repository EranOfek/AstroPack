...
function UpdateCRC32(InitCRC: LongWord; var Buffer;  Length: LongInt): LongWord;
...
function FileCRC32(FileName: String; var CRC32: LongWord): Boolean; { Return True if ok }
