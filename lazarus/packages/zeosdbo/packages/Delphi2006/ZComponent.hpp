...
// (DO NOT EDIT: machine generated header) 'Zcomponent.pas' rev: 10.00

#ifndef ZcomponentHPP
#define ZcomponentHPP
...
#include <Zstreamblob.hpp>	// Pascal unit
#include <Zabstractconnection.hpp>	// Pascal unit
#include <Zgroupedconnection.hpp>	// Pascal unit
#include <Zconnectiongroup.hpp>	// Pascal unit
#include <Zconnection.hpp>	// Pascal unit
#include <Zdataset.hpp>	// Pascal unit
#include <Zdatasetutils.hpp>	// Pascal unit
#include <Zsqlstrings.hpp>	// Pascal unit
#include <Zsqlprocessor.hpp>	// Pascal unit
#include <Zsqlmonitor.hpp>	// Pascal unit
#include <Zstoredprocedure.hpp>	// Pascal unit
#include <Zabstracttable.hpp>	// Pascal unit
#include <Zsqlmetadata.hpp>	// Pascal unit
#include <Zsequence.hpp>	// Pascal unit
#include <Zibeventalerter.hpp>	// Pascal unit
#include <Zpgeventalerter.hpp>	// Pascal unit
...
namespace Zcomponent
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Zcomponent */
using namespace Zcomponent;
#pragma pack(pop)
#pragma option pop
